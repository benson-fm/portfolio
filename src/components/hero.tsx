...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center text-white">
      <h1 className="text-9xl font-bold pb-5">Benson Manzano</h1>
      <h2 className="text-2xl pb-10">Fullstack Developer | CS @ UCI</h2>
      <div className="flex flex-row gap-11 text-2xl w-[500px] h-[50px] justify-center align-center items-center pb-36">
      ...
      <HiChevronDown  className="w-10 h-12 animate-bounce hover:cursor-pointer" onClick={handleLowerPage}/>
    </div>
  );
}
